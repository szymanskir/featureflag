...
The `featureflag` package can also be used in combination with the [config](https://cran.r-project.org/web/packages/config/index.html) package by using the R code execution feature:
